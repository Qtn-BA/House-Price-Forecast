---
title: "Prévision du prix des logements"
Authors: "BACHER Quentin -	BAHAKOULA Fanelvie - MZIU Erleta -	PIERRON Marie"
...
L'objectif est de construire un modèle de régression qui peut prédire le prix d'une propriété en fonction des caractéristiques fournies.
...
```{r}
setwd("/Users/fanelviebahakoula")
prix<-read_excel("Downloads/Projet Econométrie ETIC/bd prix de logements.xlsx")
View(prix)
